import {
  ...
  const Model = () => {
    const gltf = useGLTFLoader("/sceneGroot.gltf", true);
    console.log(gltf);

    return <primitive position={[0,-40,0]} object={gltf.scene} dispose={null} />;
  };
  ...
  const HtmlContent = () => {
    ...
    return (
      <mesh scale={[0.1,0.1,0.1]}  ref={ref} position={[0, -40, 10]}>
      <Model />
      </mesh>
      //{/*  <Html fullscreen>
